document.addEventListener("DOMContentLoaded", () => {
  ...
  const roomData = {
    ...
    PR1: {
      title: "PR - PC Room Startup, IoT dan Computer Network",
      desc: "Ruang komputer umum (Personal Computer Room Startup, IoT dan Computer Network).",
      img: "/images/pr.jpg",
      status: "Available",
    },
    PR2: {
      title: "PR - PC Room Multimedia",
      desc: "Ruang komputer umum (Personal Computer Room Multimedia).",
      img: "/images/pr.jpg",
      status: "Available",
    },
    PR3: {
      title: "PR - PC Room Compueter Vision dan Data Science",
      desc: "Ruang komputer umum (Personal Computer Room Computer Vision dan Data Science).",
      img: "/images/pr.jpg",
      status: "Available",
    },
    LR: {
    ...
    TL1: {
      title: "TL - Toilet",
      desc: "Fasilitas toilet 1.",
      img: "/images/toilet.jpg",
      status: "Open",
    },
    TL2: {
      title: "TL - Toilet",
      desc: "Fasilitas toilet 2.",
      img: "/images/toilet.jpg",
      status: "Open",
    },
    ST1: {
      title: "ST - Stairs",
      desc: "Tangga akses antar lantai 1, 2 dan 3.",
      img: "/images/stairs.jpg",
      status: "Open",
    },
    ST2: {
      title: "ST - Stairs",
      desc: "Tangga akses antar lantai 2 dan 3.",
      img: "/images/stairs.jpg",
      status: "Open",
    },
  };
