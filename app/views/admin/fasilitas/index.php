                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="inputKoordinator" name="idKordinatorAsisten" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-white">
                                ...
                                <?php if (!empty($asistenList) && is_array($asistenList)): ?>
                                    <?php foreach ($asistenList as $a): ?>
                                        <option value="<?= htmlspecialchars($a['idAsisten']) ?>">
...
<?php $fasilitasJsPath = ROOT_PROJECT . '/public/js/admin/fasilitas.js'; ?>
<script src="<?= PUBLIC_URL ?>/js/admin/fasilitas.js?v=<?= file_exists($fasilitasJsPath) ? filemtime($fasilitasJsPath) : time() ?>"></script>