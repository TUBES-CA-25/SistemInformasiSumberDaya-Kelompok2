...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Des 2025 pada 15.05
...
(12, 'Ahmad Pratama', '2022', 'Divisi Multimedia', 'https://placehold.co/300x300/667eea/white?text=Ahmad', 'UI/UX Designer', 'Gojek', 'Laboratorium membentuk kreativitas saya dan membuat saya percaya bahwa desain itu penting.', '2022', 'Figma, Adobe XD, UI/UX Design, Web Design', 'https://linkedin.com/in/ahmad-pratama', 'https://ahmad-design.com', 'ahmad@email.com', '2025-12-20 15:43:11', '2025-12-20 15:43:11');
...
(3, 'Siti Nurhaliza', 'Sistem Informasi', NULL, NULL, NULL, NULL, '', '', 'siti@mail.com', NULL, 'CCA', 0),
(4, 'Ahmad Wijaya', 'Teknik Komputer', NULL, NULL, NULL, NULL, NULL, NULL, 'ahmad@mail.com', NULL, '1', 0),
(5, 'Rina Puspita', 'Informatika', NULL, NULL, NULL, NULL, NULL, NULL, 'rina@mail.com', NULL, '1', 1),
...
(9, 'M RIZWAN', 'Teknik Informatika', NULL, NULL, NULL, NULL, 'halo saya rizwan', '[\"PHP\",\"Laravel\"]', 'rizwan@example.com', 'asisten_1766495391_7606.png', 'Asisten', 0);
...
(7, 'Microcontroller', 4, 'Tempat untuk belajar Microcontroller', 'lab_1766584749_5435.jpg', 20, 25, 'Gedung Fakultas Ilmu Komputer lantai 2', 25, 'Intel i5', '8GB', '256GB SSD', 'Integrated', '21 inch', 'Visual Studio Code', 'AC, WiFi', 'M. Rizwan', 'koordinator_1766067968_69440f0027653.png'),
...
(12, 'IoT', NULL, 'Digunakan untuk praktikum IoT', NULL, 24, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `laboratorium_gambar` (`idGambar`, `idLaboratorium`, `namaGambar`, `deskripsiGambar`, `isUtama`, `urutan`) VALUES
(1, 7, 'lab_1766584749_5435.jpg', 'Gambar ruangan utama', 1, 0);
...
(4, 'admin', '$2y$10$9dZeOKeyCyGLbICQl4l2S.rhW9VQd7Tj5iqbdSe43yG1YKUv3Utey', 'admin', '2025-12-23 20:47:52', '2025-12-22 14:47:00');
...
--
ALTER TABLE `asisten`
  MODIFY `idAsisten` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `laboratorium`
  MODIFY `idLaboratorium` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
